...
export const EDIT_P_SONGS = "EDIT_P_SONGS";
...
export const RESET_EDITPSONGS = "RESET_EDITPSONGS";
export const RESET_USERSID_USERFAVS = "RESET_USERSID_USERFAVS";

// FILTER SONGS
export const FILTER_SONGS_ARTIST = "FILTER_SONGS_ARTIST";
export const FILTER_SONGS_POPULARITY = "FILTER_SONGS_POPULARITY";
export const FILTER_SONGS_EXPLICIT = "FILTER_SONGS_EXPLICIT";
export const FILTER_SONGS_ALPHABET = "FILTER_SONGS_ALPHABET";