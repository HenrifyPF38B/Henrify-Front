  ...
  return ( 
    <div className={styles.wrapper}>
      ...
      <div className={styles.container}>
        ...
        {
          (first || second || third) &&
          <div className={styles.backHome} onClick={()=> navigate("/home")}>
            ...
            <div className={styles.secondPart}>
              ...
              <div className={styles.newsLetter}>
                <div className={styles.newsLetter1}>
                  <h3><i className="fa-solid fa-paper-plane me-2" style={{color:"rgb(128, 46, 16)"}}></i>Subscribe For Newsletters</h3>
                  <p>Would you like to receive our daily offers, discounts & more? Just let us know!</p>
                <div className="signup-checkbox-wrapper-10">
                  <input className="tgl tgl-flip" id="cb5" type="checkbox" onChange={(e)=> e.target.checked ? setNewsLetter(true) : setNewsLetter(false)} checked={newsLetter ? true : false} />
                  <label className="tgl-btn" data-tg-off="Nope" data-tg-on="Yes!" for="cb5"></label>
                </div>
                </div>
                <div className={styles.newsLetter2}>
                  <div>
                    <img src="/images/mailman2.svg" alt="abc" width={150} />
                  </div>
                </div>
              </div>
            </div>
