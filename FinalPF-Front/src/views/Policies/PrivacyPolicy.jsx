...
const PrivacyPolicy = () => {
  ...
  const { refFAQS, refFAQS1, refFAQS2, refFAQS3, refFAQS4, refFAQS5, refPrivacyPolicy, refRefundPolicy, refShippingPolicy, refTermsCond } = dataContext;
        ...
        <details className={styles.faqsDet} ref={refFAQS}>
          ...
          <div className={styles.faqs}>
              <div ref={refFAQS1}>
                ...
                <p>In order to create an account just follow this link and follow the steps! <Link to="/sign-up">Create account</Link></p>
              </div>
              <div ref={refFAQS2}>
                <h2>How do I make a purchase?</h2>
                <p>In order to make a purchase you must have an account, if you don't have one please see the section above. Once created, add any Album or Playlist to your cart, and click checkout. From there just follow the steps provided!</p>
              </div>
              <div ref={refFAQS3}>
                <h2>Can I reset my password?</h2>
                <p>If you forgot your password please follow this link and enter your email, you'll receive an email from us, just follow the instructions provided!</p>
                <p>If you have access to your account but just want to reset your password, just to to '<b>My Account</b> - <b>Password</b>'</p>
              </div>
              <div ref={refFAQS4}>
                <h2>Can I delete my account?</h2>
                <p>You will be able to delete your account by going to '<b>My Account</b> - <b>Delete Account</b>', please remember this action is permanent and it can't be undone.</p>
              </div>
              <div ref={refFAQS5}>
                <h2>How do I see my orders?</h2>
                <p>You will be able to see your orders by going into '<b>My Account</b> - <b>Orders</b>'.</p>
              </div>
          </div>
        </details>
      </div>
      <div className={styles.privacyPolicyDiv}>
        <details className={styles.privacyPolicyDet} ref={refPrivacyPolicy}>
          ...
          <div className={styles.privacyPolicy}>
              <section>
                <h2>Introduction</h2>
                <p>Welcome to Soul Music. We are committed to protecting your personal information and your right to privacy.</p>
              </section>

              <section>
                  <h2>Information We Collect</h2>
                  <p>We may collect personal information that you provide voluntarily when using our website, including [list the types of information, such as name, email address, etc.]. We may also automatically collect certain information when you visit our website.</p>
              </section>

              <section>
                  <h2>How We Use Your Information</h2>
                  <p>We use the information we collect to [describe how you will use the collected information, such as improving the website, providing services, etc.].</p>
              </section>

              <section>
                  <h2>Disclosure of Your Information</h2>
                  <p>We may disclose your personal information to [describe who you may share the information with, such as third-party service providers, affiliates, etc.] for [describe the purpose of disclosure, such as processing payments, providing customer support, etc.].</p>
              </section>

              <section>
                  <h2>Your Choices</h2>
                  <p>You have the right to [describe user rights, such as access, update, delete personal information]. You can opt-out of [describe any specific data processing activities, such as receiving marketing emails].</p>
              </section>

              <section>
                  <h2>Security</h2>
                  <p>We take appropriate security measures to protect your personal information. However, no method of transmission over the internet is 100% secure.</p>
              </section>
              ...
              <section>
                  <h2>Contact Us</h2>
                  <p>If you have any questions about our privacy policy, please contact us at [provide contact information].</p>
              </section>
      ...
      <div className={styles.termsAndConditionsDiv}>
        <details className={styles.termsAndConditionsDet} ref={refTermsCond}>
          ...
          <div className={styles.termsAndConditions}>
              <p>Welcome to Your Website! These terms and conditions outline the rules and regulations for the use of our website.</p>
              ...
              <p>The content on our website, including text, images, audio, and video, is protected by intellectual property rights. You may not reproduce, distribute, modify, or create derivative works based on our content without our explicit permission.</p>
              ...
              <h2>Content Usage</h2>
              <p>Users may contribute content, such as playlists and comments. By submitting content, you grant us a license to use, reproduce, modify, and display the content on our platform.</p>

              <h2>Prohibited Activities</h2>
              <p>You agree not to: (a) Violate any laws; (b) Post unauthorized or unsolicited advertising; (c) Impersonate others; (d) Interfere with the website's functionality.</p>

              <h2>Termination</h2>
              <p>We may suspend or terminate your account if you violate these Terms and Conditions. You can also stop using the service at any time.</p>

              <h2>Limitation of Liability</h2>
              <p>We are not liable for any indirect, incidental, special, consequential, or punitive damages arising out of your use of our website.</p>

              <h2>Changes to Terms</h2>
              <p>We may modify or update these Terms and Conditions. It's your responsibility to review them periodically.</p>

              <h2>Contact Us</h2>
              <p>If you have questions about these Terms and Conditions, contact us at <a href="mailto:henrifyb@gmail.com">henrifyb@gmail.com</a>.</p>
