...
import MembershipModal from "../../modals/buyMembership";
...
const BeMember = () => {
  ...
  return (
    <div className={style.container}>
      {/* Los modales siempre se ponen abajo del container principal*/}
      {/* Le pasamos el state como parametro para poder cerrar el modal, porquee cuando ese state sea false, se cierra */}
      {
        membershipModal && 
          <MembershipModal setMembershipModal={setMembershipModal}/>
      }
